...
# Thêm thư mục src/cnn vào path để import được model và layers
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
cnn_dir = os.path.join(os.path.dirname(CURRENT_DIR), 'cnn')
...
# Model nằm ở src/weight, trong khi script này ở src/character_classifier
